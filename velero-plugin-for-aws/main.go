...
func main() {
	veleroplugin.NewServer().
		...
		RegisterBackupItemAction("velero.io/aws", newAwsBackupItemAction).
		Serve()
}
...
func newAwsBackupItemAction(logger logrus.FieldLogger) (interface{}, error) {
	return newBackupItemAction(logger), nil
}
